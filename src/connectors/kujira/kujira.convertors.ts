...
export const convertClobPostOrderRequestToPlaceOrderOptions = (
  ...
  return {
    ...
    marketId: request.market,
    ownerAddress:
      typeof request == ClobPostOrderRequest
        ? (request as ClobPostOrderRequest).address
        : undefined,
    side: request.side,
...
export const convertClobGetOrderRequestToGetOrderOptions = (
  ...
  return {
    exchangeOrderId: request.orderId,
    marketId: request.market,
    marketIds: undefined,
...
export const convertClobDeleteOrderRequestToCancelOrderOptions = (
  ...
  return {
    exchangeOrderId: request.orderId,
    ownerAddress:
      typeof request == ClobDeleteOrderRequest
        ? (request as ClobDeleteOrderRequest).address
        : undefined,
    marketId: request.market,
